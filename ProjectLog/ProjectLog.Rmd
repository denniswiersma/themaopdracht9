...
Last but not least we shall add Naive Bayes to our list of algorithms. \
To start we'll run all of these algorithms with their default settings performing 10-fold cross validation on the dataset.
