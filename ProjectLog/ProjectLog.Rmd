...
\begin{table}[thb]
\caption{\label{RandomForestIterations}Comparison of bagging with RandomForests using a varying number of bagging iterations and cost sensitive classification after performing SMOTE on the dataset, using a RandomForest without bagging as a baseline.}
\footnotesize
{\centering \begin{tabular}{lr||r@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}c}
\hline
