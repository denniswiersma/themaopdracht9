...
All tables containing test results were generated by the Weka experimenter. A white dot represents a statistically significant higher result than ZeroR, while a black dot represents a statistically significant lower result than ZeroR.
...
\begin{table}[thb]
\caption{\label{DefaultMLRefs}References to ML algorithms below}
\scriptsize
{\centering
\begin{tabular}{cl}\\
(1) & rules.ZeroR '' \\
...
\begin{table}[thb]
\caption{\label{DefaultTime}Comparison of Elapsed time using default settings}
\footnotesize
...
\hline
R-data-frame & 0.00 & 0.00 &         & 0.00 &         & 0.01 & $\circ$ & 0.04 & $\circ$ & 0.00 & $\circ$ & 0.00 &         & 0.00 &        \\
\hline
...
\begin{table}[thb]
\caption{\label{DefaultAcc}Comparison of Accuracy using default settings}
\footnotesize
{\centering \begin{tabular}{lrr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}c}
\\
\hline
Dataset & (1)& (2) & & (3) & & (4) & & (5) & & (6) & & (7) & & (8) & \\
\hline
R-data-frame & 84.80 & 84.41 & $\bullet$ & 83.98 & $\bullet$ & 84.92 &         & 78.52 & $\bullet$ & 81.79 & $\bullet$ & 85.43 & $\circ$ & 84.79 &        \\
\hline
\multicolumn{16}{c}{$\circ$, $\bullet$ statistically significant improvement or degradation}\\
\end{tabular} \footnotesize \par}
\end{table}
...
\begin{table}[thb]
\caption{\label{DefaultF}Comparison of F-measure using default settings}
\footnotesize
{\centering \begin{tabular}{lrr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}c}
\\
\hline
Dataset & (1)& (2) & & (3) & & (4) & & (5) & & (6) & & (7) & & (8) & \\
\hline
R-data-frame & 0.92 & 0.92 & $\bullet$ & 0.91 & $\bullet$ & 0.92 &         & 0.87 & $\bullet$ & 0.90 & $\bullet$ & 0.92 & $\circ$ & 0.92 &        \\
\hline
\multicolumn{16}{c}{$\circ$, $\bullet$ statistically significant improvement or degradation}\\
\end{tabular} \footnotesize \par}
\end{table}
...
\begin{table}[thb]
\caption{\label{DefaultROC}Comparison of ROC Area using default settings}
\footnotesize
{\centering \begin{tabular}{lrr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}cr@{\hspace{0.1cm}}c}
\\
\hline
Dataset & (1)& (2) & & (3) & & (4) & & (5) & & (6) & & (7) & & (8) & \\
\hline
R-data-frame & 0.50 & 0.51 & $\circ$ & 0.64 & $\circ$ & 0.69 & $\circ$ & 0.56 & $\circ$ & 0.71 & $\circ$ & 0.73 & $\circ$ & 0.50 &        \\
\hline
\multicolumn{16}{c}{$\circ$, $\bullet$ statistically significant improvement or degradation}\\
\end{tabular} \footnotesize \par}
\end{table}
