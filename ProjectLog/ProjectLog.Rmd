...
\begin{table}[thb]
\caption{\label{OneRBucketSize}Comparison of ZeroR using varying bucket sizes and a cost sensitive classification, based on elapsed testing time, accuracy, False Negative Rate, F-measure, and ROC Area after performing SMOTE on the dataset, using ZeroR's default settings as a baseline.}
\footnotesize
