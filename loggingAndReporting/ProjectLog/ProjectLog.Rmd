...
\begin{table}[thb]
\caption{\label{RedoCostMatrix}Comparison of RandomForests with boosting while using cost sensitive classification with a FN cost of 2.5 after performing SMOTE on the dataset, using a FN cost of 2 as a baseline.}
\footnotesize
...
\begin{table}[thb]
\caption{\label{AttributeSelector}Comparison of attribute selection with RandomForests while using boosting and cost sensitive classification after performing SMOTE on the dataset, using no attribute selector as a baseline.}
\footnotesize
{\centering \begin{tabular}{lr||r@{\hspace{0.1cm}}c} \\
\hline
